...
-- Custom check constraints for data integrity
ALTER TABLE "salaries" ADD CONSTRAINT "confidence_score_range" CHECK ("confidence_score" >= 0.0 AND "confidence_score" <= 1.0);
ALTER TABLE "salaries" ADD CONSTRAINT "experience_years_range" CHECK ("experience_years" > 0 AND "experience_years" < 51);
